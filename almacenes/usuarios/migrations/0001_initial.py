# Generated by Django 5.0.3 on 2024-07-15 02:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='usuarios.area')),
                ('mango', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='usuarios.mango')),
