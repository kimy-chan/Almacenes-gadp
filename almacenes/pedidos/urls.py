...
from .views import index, imprecion_solicitud,autorizar_pedidos_almacen,informacion_pedido_no_aceptado_por_almacen,generate_pdf,buscador,mostrar_informacion_pedidio_aprobaciones, realizar_pedido, listar_pedidos, mis_pedidos,todos_mis_pedidos, listar_pedidos_unidad, autorizar_pedidos, listar_Pedidos_secretarias, rechazar_pedido_unidad, eliminar_mi_pedido, autorizar_pedidos_unidad_mayor, rechazar_pedido_unidad_mayor
...
urlpatterns = [
   ...
   path('informacion_pedido/<int:id_usuario>',informacion_pedido_no_aceptado_por_almacen , name='informacion_pedido' ),
